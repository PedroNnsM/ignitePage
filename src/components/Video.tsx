                    ...
                    <div className="flex-1">
                        ...
                        <div className=" flex items-center gap-4 mt-6">
                            ...
                            className="h-16 w-16 rounded-full border-2 border-blue-500"
                             src="https://github.com/pedronnsm.png"
                              alt=""
                            />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Pedro Nunes</strong>
                                <span className="text-gray-200 text-sm block">Front-End Devoloper</span>
                            </div>
                        </div>
                    </div>
